...
if __name__ == '__main__':
    # Handle Arguments
    parser = argparse.ArgumentParser(description='Evaluate parser output on the representation from Kummerfeld (2016).')
    # Input
