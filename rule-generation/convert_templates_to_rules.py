...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Generate inference rules from templates in LaTeX.')
    parser.add_argument('--check', help='Check the templates for consistency.', action='store_true')
    parser.add_argument('--codegen', help='Do rule generation.', action='store_true')
    parser.add_argument('--arcs', help='Generate arc rules.', action='store_true')
    parser.add_argument('--combinations', help='Generate combination rules.', action='store_true')
